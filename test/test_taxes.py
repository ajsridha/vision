...
class TestTaxes(BaseTestCase):
    ...
    def test_1(self):
        ...
        eq_(expense['tax1_amount'], Decimal("32.10"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")

    @vcr.use_cassette('fixtures/vcr_cassettes/2.yaml', filter_query_parameters=['key'])
    def test_2(self):
        expense = self.scan_expense('3000060-26246.jpeg')
        eq_(expense['tax1_amount'], Decimal("5.11"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_6(self):
        ...
        eq_(expense['tax1_amount'], Decimal("7.15"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_7(self):
        ...
        eq_(expense['tax1_amount'], Decimal("0.75"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_12(self):
        ...
        eq_(expense['tax1_amount'], Decimal("5.28"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_13(self):
        ...
        eq_(expense['tax1_amount'], Decimal("2.41"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_23(self):
        ...
        eq_(expense['tax1_amount'], Decimal("1.75"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_24(self):
        ...
        eq_(expense['tax1_amount'], Decimal("8.75"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_25(self):
        ...
        eq_(expense['tax1_amount'], Decimal("4.00"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_26(self):
        ...
        eq_(expense['tax1_amount'], Decimal("0.10"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_28(self):
        ...
        eq_(expense['tax1_amount'], Decimal("1.89"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_29(self):
        ...
        eq_(expense['tax1_amount'], Decimal("1.86"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_30(self):
        ...
        eq_(expense['tax1_amount'], Decimal("0.65"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_33(self):
        ...
        eq_(expense['tax1_amount'], Decimal("29.22"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_34(self):
        ...
        eq_(expense['tax1_amount'], Decimal("31.40"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_35(self):
        ...
        eq_(expense['tax1_amount'], Decimal("24.85"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_37(self):
        ...
        eq_(expense['tax1_amount'], Decimal("1.30"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_38(self):
        ...
        eq_(expense['tax1_amount'], Decimal("5.18"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_39(self):
        ...
        eq_(expense['tax1_amount'], Decimal("4.74"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_40(self):
        ...
        eq_(expense['tax1_amount'], Decimal("2.59"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_43(self):
        ...
        eq_(expense['tax1_amount'], Decimal("4.81"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_50(self):
        ...
        eq_(expense['tax1_amount'], Decimal("18.34"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_51(self):
        ...
        eq_(expense['tax1_amount'], Decimal("15.47"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_57(self):
        ...
        eq_(expense['tax1_amount'], Decimal("1.01"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_59(self):
        ...
        eq_(expense['tax1_amount'], Decimal("6.92"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_60(self):
        ...
        eq_(expense['tax1_amount'], Decimal("0.95"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_61(self):
        ...
        eq_(expense['tax1_amount'], Decimal("0.55"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_68(self):
        ...
        eq_(expense['tax1_amount'], Decimal("35.30"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_69(self):
        ...
        eq_(expense['tax1_amount'], Decimal("37.71"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_70(self):
        ...
        eq_(expense['tax1_amount'], Decimal("18.73"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_75(self):
        ...
        eq_(expense['tax1_amount'], Decimal("0.47"))
        eq_(expense['tax2_amount'], Decimal("0.08"))
        eq_(expense['tax3_amount'], Decimal("0.08"))
    ...
    def test_79(self):
        ...
        eq_(expense['tax1_amount'], Decimal("3.15"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_90(self):
        ...
        eq_(expense['tax1_amount'], Decimal("0.62"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_92(self):
        ...
        eq_(expense['tax1_amount'], Decimal("7.16"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
    ...
    def test_98(self):
        ...
        eq_(expense['tax1_amount'], Decimal("6.88"))
        eq_(expense['tax2_amount'], "")
        eq_(expense['tax3_amount'], "")
